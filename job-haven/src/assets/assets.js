...
import character_presenting_3 from './character_presenting_3.png';

// landing page
import avatar from './avatar.jpg';
import avatar_0 from './avatar_0.jpg';
...
import working_man_9 from './working_man_9.png';
...
export const assets = {
  ...
  avatar_4,
  working_man_9,
  character_presenting_3,
};

export const companiesNames = ['Google', 'Amazon', 'Figma', 'Netflix', 'Meta', 'Microsoft', 'Pinterest', 'Slack', 'Spotify', 'Oracle', 'Walmart'];

export const miniJobCategory = [
  {
    name: 'Arts & Design',
    description: 'Create visuals and design content for media.',
    jobs: 42,
  },
  {
    name: 'Content Writing',
    description: 'Write content for websites, blogs, and media.',
    jobs: 58,
  },
  {
  ...
  {
    name: 'Data Entry',
    description: 'Enter and manage data in digital systems.',
    jobs: 61,
  },
  {
    name: 'Digital Marketing',
    description: 'Promote brands through digital platforms.',
    jobs: 47,
  },
  {
    name: 'Finance',
    description: 'Manage accounts, budgets, and reports.',
    jobs: 29,
  },
  {
    name: 'Human Resource',
    description: 'Handle hiring and employee relations.',
    jobs: 22,
  },
  {
    name: 'Sales',
    description: 'Sell products or services and build customer relationships.',
    jobs: 53,
  },
  {
    name: 'UI-UX Designer',
  ...
  {
    name: 'Web Developer',
    description: 'Build and maintain websites and apps.',
    jobs: 45,
  },
];
...
export const testimonials = [
  {
    name: 'Aarav Mehta',
    testimonial: 'Absolutely love how intuitive this platform is. Found multiple relevant jobs within days.',
    rating: 5,
  },
  {
    name: 'Vikram Bhatt',
    testimonial: 'Clean design, powerful filters, and trustworthy listings. This portal is a game changer!',
    rating: 4.5,
  },
  {
    name: 'Karan Sethi',
    testimonial: 'I recommended this to my friends and even my college’s placement cell.',
    rating: 5,
  },
  {
    name: 'Aditya Chauhan',
    testimonial: 'Navigating through roles and applying was super smooth. Excellent platform for freshers.',
    rating: 4.5,
  },
];

export const JobCategories = ['Programming', 'Data Science', 'Designing', 'Networking', 'Management', 'Marketing', 'Cybersecurity'];

export const JobLocations = ['Bangalore', 'Washington', 'Hyderabad', 'Mumbai', 'California', 'Chennai', 'New York'];
...
// Sample data for user home Page
